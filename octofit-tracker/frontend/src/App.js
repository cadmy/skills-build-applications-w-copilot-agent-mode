    ...
    <Router>
      <div className="container mt-4">
        ...
        <Routes>
          ...
          <Route path="/" element={<div className="card mx-auto" style={{maxWidth: '30rem'}}><div className="card-body"><h2 className="card-title">Welcome to OctoFit Tracker!</h2><p className="card-text">Select a section from the navigation menu to get started.</p></div></div>} />
        </Routes>
      </div>
    </Router>
  );
